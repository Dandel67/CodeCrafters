...
catalogo = Catalogo(host='xxdiegoxx.mysql.pythonanywhere-services.com',
                    user='xxdiegoxx', password='diego12345', database='xxdiegoxx$proyectoapp')

# Carpeta para guardar las imagenes
ruta_destino = '/home/xxdiegoxx/mysite/static/imagenes'
